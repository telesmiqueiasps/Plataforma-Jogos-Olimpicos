...
from app.api.routes import athletes, auth, boardgame, cantina, championships, churches, credentials, draws, feedbacks, games, modality_mappings, race, sports, suspensions, teams, tenis_mesa, users, webhook
...
app.include_router(modality_mappings.router, prefix="/api")
